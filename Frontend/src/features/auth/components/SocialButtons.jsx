...
const GoogleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" style={{ width: '14px', height: '14px', flexShrink: 0 }}>
...
const AppleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style={{ width: '14px', height: '14px', flexShrink: 0 }} fill="currentColor">
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="font-label text-[9px] tracking-[0.2em] uppercase text-stone-400">OR</span>
        <div className="flex-1 border-t border-stone-200" />
      </div>

      {/* Google + Apple */}
      <div className="grid grid-cols-2 gap-2.5">
        <button type="button" onClick={onGoogle} className={btnClass}>
          <GoogleIcon />
          Google
        </button>
